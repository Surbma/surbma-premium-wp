...
function surbma_premium_wp_google_analytics_init() {
	...
	add_settings_field(
		'surbma_premium_wp_google_analytics_options',
		'További opciók',
		'surbma_premium_wp_google_analytics_options_string',
		'surbma-premium-wp-google-analytics',
		'surbma_premium_wp_google_analytics'
	);
}
...
function surbma_premium_wp_google_analytics_options_string() {
    ...
    $html .= '<label class="description" for="surbma_premium_wp_google_analytics_fields[anonymizeip]">IP-névtelenítés (IP Anonymization) engedélyezése</label>';
