...
add_action( 'admin_init', function() {
	...
	add_settings_field( 'surbma_premium_wp_google_tag_manager_id', 'GTM tároló azonosító', 'surbma_premium_wp_google_tag_manager_id_string', 'surbma-premium-wp-google-tag-manager', 'surbma_premium_wp_google_tag_manager' );
}, 50 );
